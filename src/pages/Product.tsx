  ...
  return (
    <div className='flex gap-x-5 items-center '>
      <div>
        ...
        <input type="text" className='bg-gray-200 px-3 py-2 rounded-md outline-none' />
      </div>
      <div>
        <p className='text-xs text-gray-400 font-semibold mb-1'>Product Price</p>
        <input type="number" className='bg-white border border-gray-400 rounded-md px-5 py-2 outline-none' />
      </div>
    </div>
  )
}